...
function mapSlider() {
    new Swiper('.map-swiper', {
        ...
        watchOverflow: true,
        navigation: {
            nextEl: '.map-slider .swiper-button-next',
            prevEl: '.map-slider .swiper-button-prev',
        },
        a11y: {
            enabled: false,
        },
...
function actSlider() {
    new Swiper('.act-swiper', {
        ...
        watchOverflow: true,
        navigation: {
            nextEl: '.act-gallery .swiper-button-next',
            prevEl: '.act-gallery .swiper-button-prev',
        },
        a11y: {
            enabled: false,
        },
...
function spainSlider() {
    new Swiper('.spain-swiper', {
        effect: "slide",
        loop: false,
        speed: 800,
        // autoplay: {
        ...
        watchOverflow: true,
        navigation: {
            nextEl: '.spain-slider .swiper-button-next',
            prevEl: '.spain-slider .swiper-button-prev',
        },
        a11y: {
            enabled: false,
        },
...
function groupTabspainSlider() {
    ...
    //var swiper = new Swiper('.grouptab-spain-swiper', {
    //    effect: "slide",
    //    loop: false,
    //    speed: 800,
    //    // autoplay: {
    ...
    //    setTab(swiper.realIndex + 1);
    //});
}

//function initGroupTab() {
//    $(document).on('click', '#groupTab li', function () {
//        var that = $(this);
//        const swiperElement = document.querySelector('.grouptab-spain-swiper');
//        if (swiperElement) {
...
//    $('#groupTab_' + index).addClass("active");
//}
...
function journeyPicSlider() {
    if ($('.journeys-pic-swiper').length) {
        $('.journeys-pic-swiper').each(function () {
            new Swiper(this, {
                effect: "slide",
                loop: false,
                speed: 800,
...
function convenientSlider() {
    new Swiper('.convenient-swiper', {
        effect: "slide",
        loop: false,
        speed: 800,
        // spaceBetween: 20,
        ...
        watchOverflow: true,
        navigation: {
            nextEl: '.convenient-slider .swiper-button-next',
            prevEl: '.convenient-slider .swiper-button-prev',
        },
        a11y: {
            enabled: false,
        },
...
function tabMapParkZone() {
    $(document).on('click', '.parkzone-button li', function () {
        var that = $(this);
        var target = that.attr('data-map');
        if (!that.hasClass('active')) {
            $('.parkzone-button li').removeClass('active');
            that.addClass('active');
            $('.box-map-pic .pic-parkzone').removeClass('active');
            $('.box-map-pic .pic-parkzone[data-map=' + target + ']').addClass('active');
        }
    });
}
...
//        var loop = true;
//        var number = document.querySelectorAll('.library-item').length;
//        if (number <= 3) {
//            loop = false;
//            document.querySelector('.library-slider').classList.add('hide-controls');
//        }
//        new Swiper('.library-swiper', {
//            effect: "slide",
//            loop: loop,
...
//            },
//            navigation: {
//                nextEl: '.library-line .swiper-button-next',
//                prevEl: '.library-line .swiper-button-prev',
//            },
//            on: {
//                init: function () { },
//                transitionStart: function () {
