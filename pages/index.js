...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Luyện đề thi */}
      <Box maxW="1200px" mx="auto" mt={8} mb={12} px={4}>
              ...
              <Tabs.Content key={idx} value={section.value}>
                <Flex gap={4} wrap="wrap" justify={'start'}>
                  {section.parts.map((part, idp) => (
                    <Box borderWidth={1} borderRadius='4px' p="4" spaceY="2" key={`part-${idp}`} width={{base: '100%', md: '30%'}} mb={4}>
      ...
      <Box maxW="1200px" mx="auto" mb={12} px={4}>
      ...
      <Box maxW="1200px" mx="auto" mb={12} px={4}>
        ...
        <Flex gap={4} wrap="wrap" justify={'start'}>
          {reviews.map(r => (
            <Box key={r.id} p={4} borderWidth="1px" borderRadius="lg" bg="white" boxShadow="md">
