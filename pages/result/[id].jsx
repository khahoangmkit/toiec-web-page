    ...
    <Box p={8}>
      <Stack boxShadow="2xl" bg="white" rounded="xl" p={4} spacing={8} width="100%" align="left">
        ...
        <Flex direction="column" align="left" justify="center" >
          <Box mb={2}>
            <HStack spacing={4}>
              <Box bg="green.100" color="green.800" px={5} py={3} borderRadius="lg" width="140px" height="110px" textAlign="center" fontWeight="bold" boxShadow="md" display="flex" flexDirection="column" alignItems="center" justifyContent="center">
                <Text fontSize="lg">Đúng</Text>
                <Text fontSize="2xl">{testResults.correct}</Text>
              </Box>
              <Box bg="blue.100" color="blue.800" px={5} py={3} borderRadius="lg" width="140px" height="110px" textAlign="center" fontWeight="bold" boxShadow="md" display="flex" flexDirection="column" alignItems="center" justifyContent="center">
                <Text fontSize="lg">Listening</Text>
                <Text fontSize="xl">{testResults.correctListen}</Text>
              </Box>
              <Box bg="purple.100" color="purple.800" px={5} py={3} borderRadius="lg" width="140px" height="110px" textAlign="center" fontWeight="bold" boxShadow="md" display="flex" flexDirection="column" alignItems="center" justifyContent="center">
                <Text fontSize="lg">Reading</Text>
                <Text fontSize="xl">{testResults.correctRead}</Text>
              </Box>
              <Box bg="red.100" color="red.800" px={5} py={3} borderRadius="lg" width="140px" height="110px" textAlign="center" fontWeight="bold" boxShadow="md" display="flex" flexDirection="column" alignItems="center" justifyContent="center">
                <Text fontSize="lg">Sai</Text>
                <Text fontSize="2xl">{testResults.incorrect}</Text>
              </Box>
              <Box bg="yellow.100" color="yellow.800" px={5} py={3} borderRadius="lg" width="140px" height="110px" textAlign="center" fontWeight="bold" boxShadow="md" display="flex" flexDirection="column" alignItems="center" justifyContent="center">
                <Text fontSize="lg">Bỏ qua</Text>
                <Text fontSize="2xl">{testResults.skipped}</Text>
              </Box>
              <Box bg="gray.200" color="gray.900" px={5} py={3} borderRadius="lg" width="140px" height="110px" textAlign="center" fontWeight="bold" boxShadow="md" display="flex" flexDirection="column" alignItems="center" justifyContent="center">
